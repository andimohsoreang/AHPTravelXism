...
(function webpackUniversalModuleDefinition(root, factory) {
    ...
    return /******/ (function () {
                ...
                var Choices = /** @class */ (function () {
                    function Choices(element, userConfig) {
                        ...
                        if (this.passedElement.value && this._isTextElement) {
                            ...
                            this._presetItems =
                                this._presetItems.concat(splitValues);
                        }
                    ...
                    Choices.prototype.highlightItem = function (
                        item,
                        runEvent
                    ) {
                        if (runEvent === void 0) {
                        ...
                        this._store.dispatch(
                            (0, items_1.highlightItem)(id, true)
                        );
                        if (runEvent) {
                    ...
                    Choices.prototype.unhighlightItem = function (item) {
                        ...
                        var group =
                            groupId >= 0
                                ...
                                : null;
                        this._store.dispatch(
                            (0, items_1.highlightItem)(id, false)
                        );
                        this.passedElement.triggerEvent(
                            constants_1.EVENTS.highlightItem,
                            {
                    ...
                    Choices.prototype.removeActiveItems = function (
                        excludedId
                    ) {
                        var _this = this;
                        this._store.activeItems
                    ...
                    Choices.prototype.hideDropdown = function (
                        preventInputBlur
                    ) {
                        var _this = this;
                        if (!this.dropdown.isActive) {
                    ...
                    Choices.prototype._createChoicesFragment = function (
                        ...
                        if (
                            ...
                            rendererableChoices = choices.filter(function (
                                choice
                            ) {
                    ...
                    Choices.prototype._handleBackspace = function (
                        activeItems
                    ) {
                    ...
                    Choices.prototype._searchChoices = function (value) {
                        ...
                        this._store.dispatch(
                            (0, choices_1.filterChoices)(results)
                        );
        ...
        */
                    ...
                    Choices.prototype._onSelectKey = function (
                        event,
                        hasItems
                    ) {
                    ...
                    Choices.prototype._onFocus = function (_a) {
                        ...
                        var focusActions =
                            ...
                            (_b[constants_1.SELECT_MULTIPLE_TYPE] =
                                function () {
                                    if (target === _this.input.element) {
                                        _this.showDropdown(true);
                    ...
                    Choices.prototype._onBlur = function (_a) {
                        ...
                        if (blurWasWithinContainer && !this._isScrollingOnIe) {
                            var activeItems = this._store.activeItems;
                            var hasHighlightedItems_1 = activeItems.some(
                                function (item) {
                                    return item.highlighted;
                                }
                            );
                    ...
                    Choices.prototype._removeItem = function (item) {
                        ...
                        this._store.dispatch(
                            (0, items_1.removeItem)(id, choiceId)
                        );
                        this.passedElement.triggerEvent(
                    ...
                    Choices.prototype._addPredefinedChoices = function (
                        choices
                    ) {
                        var _this = this;
                        // If sorting is enabled or the user is searching, filter choices
            ...
            /***/ 799: /***/ function (__unused_webpack_module, exports) {
                ...
                var generateChars = function (length) {
                    return Array.from(
                        ...
                        function () {
                            return (0, exports.getRandomNumber)(0, 36).toString(
                                36
                            );
                        }
                    ).join("");
                    ...
                    switch (action.type) {
                        case "ADD_CHOICE": {
                            ...
                            var choice = {
                                ...
                                placeholder:
                                    addChoiceAction.placeholder || false,
                            };
                            /*
        ...
        */
                            ...
                            if (addItemAction_1.choiceId > -1) {
                                return state.map(function (obj) {
                                    ...
                                    if (
                                        choice.id ===
                                        parseInt(
                                            "".concat(addItemAction_1.choiceId),
                                            10
                                        )
                                    ) {
                                ...
                                [
                                    {
                                        ...
                                        placeholder:
                                            addItemAction.placeholder || false,
                                        keyCode: null,
                                    },
                                ],
                                false
            ...
            /***/ 686: /***/ function (__unused_webpack_module, exports) {
                ...
                var templates = {
                    ...
                    choiceGroup: function (_a, _b) {
                        ...
                        div.appendChild(
                            Object.assign(
                                ...
                                (_c[allowHTML ? "innerHTML" : "innerText"] =
                                    value),
                                _c)
                            )
                        );
                    ...
                    option: function (_a) {
                        ...
                        if (customProperties) {
                            opt.dataset.customProperties = "".concat(
                                customProperties
                            );
                        }
            ...
            /***/ 221: /***/ function (
                ...
                function search(
                    ...
                    for (let i = 0; i < patternLen; i += 1) {
                        ...
                        let finish = findAllMatches
                            ? textLen
                            : Math.min(expectedLocation + binMid, textLen) +
                              patternLen;
                ...
                class BitapSearch {
                    ...
                    searchIn(text) {
                        const { isCaseSensitive, includeMatches } =
                            this.options;
                ...
                class ExtendedSearch {
                    ...
                    searchIn(text) {
                        ...
                        const { includeMatches, isCaseSensitive } =
                            this.options;
                        ...
                        for (let i = 0, qLen = query.length; i < qLen; i += 1) {
                            ...
                            // ANDs
                            for (
                                let j = 0, pLen = searchers.length;
                                j < pLen;
                                j += 1
                            ) {
                                const searcher = searchers[j];
                                const { isMatch, indices, score } =
                ...
                function createStore(reducer, preloadedState, enhancer) {
                    ...
                    if (typeof enhancer !== "undefined") {
                        if (typeof enhancer !== "function") {
                            throw new Error(
                                true ? formatProdErrorMessage(1) : 0
                            );
                        }
                    ...
                    function getState() {
                        if (isDispatching) {
                            throw new Error(
                                true ? formatProdErrorMessage(3) : 0
                            );
                        }
                    ...
                    function subscribe(listener) {
                        if (typeof listener !== "function") {
                            throw new Error(
                                true ? formatProdErrorMessage(4) : 0
                            );
                        }

                        if (isDispatching) {
                            throw new Error(
                                true ? formatProdErrorMessage(5) : 0
                            );
                        }
                        ...
                        return function unsubscribe() {
                            ...
                            if (isDispatching) {
                                throw new Error(
                                    true ? formatProdErrorMessage(6) : 0
                                );
                            }
                    ...
                    function dispatch(action) {
                        if (!isPlainObject(action)) {
                            throw new Error(
                                true ? formatProdErrorMessage(7) : 0
                            );
                        }

                        if (typeof action.type === "undefined") {
                            throw new Error(
                                true ? formatProdErrorMessage(8) : 0
                            );
                        }

                        if (isDispatching) {
                            throw new Error(
                                true ? formatProdErrorMessage(9) : 0
                            );
                        }
                    ...
                    function replaceReducer(nextReducer) {
                        if (typeof nextReducer !== "function") {
                            throw new Error(
                                true ? formatProdErrorMessage(10) : 0
                            );
                        }
                ...
                function assertReducerShape(reducers) {
                    Object.keys(reducers).forEach(function (key) {
                        ...
                        if (typeof initialState === "undefined") {
                            throw new Error(
                                true ? formatProdErrorMessage(12) : 0
                            );
                        }
                        ...
                        if (
                            ...
                            throw new Error(
                                true ? formatProdErrorMessage(13) : 0
                            );
                        }
                    });
                }
                    ...
                    return function combination(state, action) {
                        ...
                        for (var _i = 0; _i < finalReducerKeys.length; _i++) {
                            ...
                            if (typeof nextStateForKey === "undefined") {
                                ...
                                throw new Error(
                                    true ? formatProdErrorMessage(14) : 0
                                );
                            }
                    ...
                    return function (createStore) {
                        return function () {
                            ...
                            var _dispatch = function dispatch() {
                                throw new Error(
                                    true ? formatProdErrorMessage(15) : 0
                                );
                            };
