                            ...
                            <div class="modal-content">
                                ...
                                <form action="#">
                                    <div class="modal-body">
                                        <label for="nama-kriteria">Nama Alternatif </label>
                                        <div class="form-group">
                                            <input id="nama-kriteria" type="text" placeholder="Nama Alternatif"
                                                class="form-control">
                                        </div>
                                    </div>
                            ...
                            <tr>
                                ...
                                <td style="width: 200px">
                                    ...
                                    <a href="#" class="btn icon btn-sm btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#UpdateAlternatif"><i class="bi bi-pencil"></i></a>
                                    {{-- end-button modal --}}
                                    {{-- form modals --}}
                                    <div class="modal fade text-left" id="UpdateAlternatif" tabindex="-1" role="dialog"
                                        aria-labelledby="myModalLabel33" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                            role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="myModalLabel33">Edit Alternatif</h4>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <input id="nama-kriteria" type="text"
                                                                placeholder="Nama Alternatif" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
